...
def suggest_resource_adjustment(resources: dict, queue_limits: dict, policy: str) -> Optional[dict]:
    """
    ...
    if memory_str:
        ...
        if max_memory_str:
            ...
            if memory_bytes and max_memory_bytes and memory_bytes > max_memory_bytes:
                ...
                suggestions["memory_reason"] = f"Reduced from {memory_str} to meet queue maximum"
        ...
        if min_memory_str:
            ...
            if memory_bytes and min_memory_bytes and memory_bytes < min_memory_bytes:
                ...
                suggestions["memory_reason"] = f"Increased from {memory_str} to meet queue minimum"
